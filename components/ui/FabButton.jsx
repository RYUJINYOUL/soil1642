...
const FabButton = () => {
  ...
  return (
    <div className="fixed right-10 bottom-10 pb-4 flex flex-col gap-3">
      {/* <div className="gap-3"> */}
        {openSubMenu && (
          <ul>
            ...
            className="my-3 flex items-center justify-center w-12 h-12 xs:w-10 xs:h-10 bg-green-500 text-white rounded-full shadow-lg transition-transform hover:scale-110">
      ...
      {/* </div> */}
      <button className="bg-blue-500 w-13 h-13 xs:w-11 xs:h-11 text-white rounded-full shadow-lg transition-transform hover:scale-110" onClick={shownSubMenuHandler}>
