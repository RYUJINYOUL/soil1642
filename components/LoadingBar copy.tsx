  ...
  return (
    ...
    <div className='min-h-[600px]'>
      ...
      <div className='flex md:flex-row flex-col md:justify-between items-start lg:w-[1100px] w-screen'>
          <div className='px-3 flex flex-col h-[40px] justify-end'>
          <div className='lg:text-start text-center text-[20px]'>소개</div>
          <hr className="mt-1 h-0.5 border-t-0 bg-neutral-700 opacity-100 w-[40px] dark:opacity-50"/>
       </div>
       ...
       <div className='md:w-[1100px] w-full px-3 flex md:flex-row flex-col justify-start items-start gap-10'>
       ...
       <Image
        ...
        <div className='flex flex-col md:w-[530px] w-full'>
          ...
          <div className='text-[15px] truncate text-start'>저희 흙광고기획은 창사 30년을 바탕으로 옥외광고 선두주자로 자리매김하여 도시경관을 선도하는 기업으로 도시미관을 책임하고 있습니다. 한가지 한가지 소비자믿음으로 성실제작하여 착한가게로 성장하고있습니다.믿고 맡겨주시면 최선을 다해 보답하겟습니다 감사합니다</div>
          <div className='md:mt-10 mt-3' />
          <div className='md:text-[20px] text-[18px] truncate text-start'>2017경기도모범옥외광고업체, 국가옥외광고사2급보유</div>
    ...
    <section className='flex flex-col justify-center items-center'>
      ...
      <div className='flex md:flex-row flex-col md:justify-between items-start lg:w-[1100px] w-screen'>
          <div className='px-3 flex flex-col h-[40px] justify-end'>
          <div className='lg:text-start text-center text-[20px]'>대표 상품 소개</div>
       ...
       <Image
        ...
        <div className='md:text-[20px] text-[18px] text-start'>LED채널</div>
          <div className='md:mt-10 mt-3' />
          <div className='text-[15px] truncate text-start'>일반적으로 많이사용되는간판입니다 기존 네온으로제작설치하여 가게홍보하였는데 요주음대세는 LED 채널사인으로 전부 이용하는 추세입니다 전기료 또한 10/1 밖에 안나오고 상호교체도 용이하므로 소비자가 많이 찾은 제품이기도 합니다.</div>
          <div className='md:mt-10 mt-3' />
          <div className='md:text-[20px] text-[18px] text-start'>LED채널</div>
          <div className='md:mt-10 mt-3' />
          <div className='text-[15px] truncate text-start'>조립또한 쉽게 조립할수 있고 영업품목 및 상호선전도 용이하여 점주 분들이 많이 찾는 제품입니다. 요즈음 트랜드죠 앞으로도 면발광이다던지 전기료절약등등 더욱 신장해나아가는 제품이기도 합니다.</div>
          <div className='md:mt-10 mt-8' />
          <div className='md:hidden block flex flex-col h-[40px] justify-end'>
          <hr className="mt-1 h-0.5 border-t-0 bg-neutral-200 opacity-100 dark:opacity-50 w-full"/>
          <div className='md:mt-10 mt-3' />
      ...
      <div className='flex flex-col'>
      <div className='flex flex-row justify-between items-center w-[1100px]'>
          <div className='flex flex-col h-[40px] justify-end'>
          <div className='lg:text-start text-center text-[20px]'>내부시설</div>
          <hr className="mt-1 h-0.5 border-t-0 bg-neutral-700 opacity-100 w-[70px] dark:opacity-50"/>
       </div>
          <div className='flex flex-col h-[40px] justify-end'>
          <div className='lg:text-end text-center text-[14px]'>더보기 &nbsp;&gt;</div>
          <hr className="mt-1 h-0.5 border-t-0 bg-neutral-200 opacity-100 dark:opacity-50 w-[1030px]"/>
       </div>
       </div>
       </div>
