  ...
  return (
    ...
    <div>
      ...
      <div className='flex md:flex-row flex-col md:justify-between items-start lg:w-[1100px] w-screen'>
          ...
          <div className='lg:text-start font-bold text-center text-[20px]'>소개</div>
       ...
       <Image
        ...
        <div className='flex flex-col md:w-[530px] w-full'>
          ...
          <div className='md:mt-10 mt-3' />
          <div className='md:text-[20px] font-bold md:block hidden text-[18px] text-start'>2017경기도모범옥외광고업체, 국가옥외광고사2급보유</div>
          <div className='md:text-[20px] font-bold md:hidden block text-[18px] truncate text-start'>2017경기도모범옥외광고업체, 국가옥외광고사2급보유</div>
    ...
    <section className='flex flex-col justify-center items-center'>
      ...
      <div className='flex md:flex-row flex-col md:justify-between items-start lg:w-[1100px] w-screen'>
          <div className='lg:px-0 px-3 flex flex-col h-[40px] justify-end'>
          <div className='lg:text-start font-bold text-center text-[20px]'>대표 상품 소개</div>
      ...
      <div className='flex md:p-0 p-3 flex-col md:w-[1100px] w-full'>
        ...
        <div className='md:text-[20px] font-bold text-[18px] text-start'>LED채널</div>
      ...
      <div className='flex md:flex-row flex-col md:justify-between items-start lg:w-[1100px] w-screen'>
          <div className='lg:px-0 px-3 flex flex-col h-[40px] justify-end'>
          <div className='lg:text-start font-bold text-center text-[20px]'>내부시설</div>
