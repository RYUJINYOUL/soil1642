      ...
      <div className='flex md:flex-row flex-col md:justify-between items-start lg:w-[1100px] w-screen'>
       ...
       <Image
        ...
        <div className='flex flex-col md:w-[530px] w-full'>
          ...
          <div className='md:mt-10 mt-3' />
          <div className='md:text-[20px] md:block hidden text-[18px] text-start'>2017경기도모범옥외광고업체, 국가옥외광고사2급보유</div>
          <div className='md:text-[20px] md:hidden block text-[18px] truncate text-start'>2017경기도모범옥외광고업체, 국가옥외광고사2급보유</div>
